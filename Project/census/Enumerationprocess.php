...
<li> <a href="logout.php"> LOGOUT </a></li>
          ...
          <fieldset>
                ...
                <label>  A2. How many people were living or staying in this house,apartment, or mobile home on  </label>
                  ...
                  <label> A3. TYPE OF HABITAT </label>                  <select name="habitant" required> 
                              <option value="" style="display:none">-- Select Habitant --</option>
                   ...
                   <option value="" style="display:none"> Select tenure  </option>
                    ...
                    <option value="" style="display:none"> Select Material Roof </option> 
     ...
     <div>                                 <label> A7.  MAIN MATERIAL OF THE WALLS</label>
                    <label> What is the main material used for the walls ?</label>                  <select name="walls" required> 
                              <option value="" style="display:none"> -- Select material of the walls --<option>
                    ...
                    <label> What is the main material used for the floor ?</label>                  <select name="floor" required> 
                     <option value="" style="display:none"> -- Select material of the floor --<option>
 ...
 <select name="water" required> 
  <option value="" style="display:none"> -- Select the source of water --<option>
 ...
 <select name="Facility" required> 
  <option value="" style="display:none"> -- Select toilet facility --<option>
 ...
 <select name="lighting" required> 
  <option value="" style="display:none"> -- Select the source of energy --<option>
 ...
 <select name="cooking" required> 
  <option value="" style="display:none"> -- Select source of energy of cooking --<option>
