...
<div id="main">
<br><br><br>
<h1> INFORMATION ABOUT CENSUS </h1>
<br>
 <form action="add_censusprocess.php" method="post">
 <div>
                    <input type="text" name="yearId" placeholder="YEAR OF CENSUS" pattern="[2]{1}[0]{1}[0-9]{2}" required />
                    </div>
                    <div>
                    <input type="text" name="Start_Date" placeholder="Start Date of Census"/>
                </div>
                <div>
                    <input type="text" name="End_Date" placeholder="End Date of Census"/>
                </div>
                 <div>
                <input type="submit" name="submit" value="Add CENSUS"/>
                </div>
 </form>
</div>
</div>
