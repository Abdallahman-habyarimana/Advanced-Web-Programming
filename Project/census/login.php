...
<body>
<div id="wrapper">
	<form name="login-form" class="login-form" action="loginprocess1.php" method="post">
		...
		<div class="content">
		<input name="username" type="text" class="input username" placeholder="Username" pattern="[A-Z]{1}[a-z]{4,6}[0-9]{1,2}" required/>
		<div class="user-icon"></div>
		<input name="password" type="password" class="input password" placeholder="Password" pattern="{6,8}" required/>
		<div class="pass-icon"></div>		
		</div>

		<div class="footer">
		<input type="submit" name="submit" value="Login" class="button" /> <br> <br> <br>
