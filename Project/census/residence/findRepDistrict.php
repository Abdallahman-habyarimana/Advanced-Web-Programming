...
<img src="../img/logo.jpg" align="center"><br>
  ...
  <table>
                <tr>
                <th> PROVINCE </th> <th> MALE  </th> <th> FEMALE  </th> <th> NON-INSURANCE </th><th> INSURANCE  </th> <th>NON-RELIGION  </th> <th> MUSLIM </th><th>CHRISTIAN  </th><th>TOTAL </th>
                </tr>
                <?
...
<? } ?><?
	...
	?>
    <tr> <td> <h3> <?=$name?> </h3></td><td> <? echo $tmale; ?> </td> <td> <? echo $tfemale; ?></td> <td> <? echo $tnone; ?> </td><td><? echo $tinsu; ?>  </td> <td> <? echo $trnone; ?></td> <td> <? echo $tmusl; ?></td> <td> <? echo $tchr; ?></td> <td> <? echo $tperson; ?></td></tr>
...
var callreport=document.getElementById("callreport");
...
callreport.style.visibility='hidden';
divtitle.style.visibility='visible';
districtdiv.style.visibility='hidden';
...
callreport.style.visibility='visible';
form1.style.visibility='visible';
districtdiv.style.visibility='visible';
...
footest.style.visibility='visible';
 ...
 <a id="callreport "href="../report.php">  Back </a>                   
 
  <input id="printpagebutton" type="button" value="Print this list" onClick="printpage()"/>  </td>                   
                             
                 <td>
             <form action="FindRepSector.php" method="post" id="form1">
               <?
