...
<section>
 ...
 <table border="1" width="70%" height="auto">
                <tr>
               <td>  Number </td> <td>  NAME </td> <td> LAST NAME  </td> <td> SEX </td> <td> RELATIONSHIP  </td><td> RELIGION </td> <td> MARITAL STATUS </td><td> INSURANCE </td> <td> LANGUAGE </td> <td> DEGREE </td> <td> ACTIVITY </td> <td> WORK </td> <td> HOUSE ID</td> <td> SECTOR NAME</td>
                </tr>      
<?
...
<? } ?>
<? 
       $query="SELECT * FROM household WHERE Id_district='$district'";
       ...
       while($row=mysql_fetch_array($result)){
                ...
                <td> <?=$pop['Marital_statue']?> </td>
                 ...
                 <td> <?=$pop['Language']?> </td>
				  ...
				  <td>   <?=$pop['House_Id']?> </td>
                  <? $a=$row['Id_sector']; 
				  $q="SELECT *from sector WHERE Id='$a'";
